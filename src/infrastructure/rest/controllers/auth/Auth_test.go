...
type MockAuthUseCase struct {
	...
	RegisterFunc             func(user useCaseAuth.RegisterUser) (*domain.CommonResponse[useCaseAuth.SecurityRegisterUser], error)
	LogoutFunc               func(string) (*domain.CommonResponse[string], error)
...
func (m *MockAuthUseCase) Register(user useCaseAuth.RegisterUser) (*domain.CommonResponse[useCaseAuth.SecurityRegisterUser], error) {
...
func (m *MockAuthUseCase) Logout(token string) (*domain.CommonResponse[string], error) {
	if m.LogoutFunc != nil {
		return m.LogoutFunc(token)
	}
	return nil, nil
}
func (m *MockAuthUseCase) LogOut(token string)
...
func TestLoginRequest_Validation(t *testing.T) {
	...
	if validRequest.Username == "invalid-email" {
